    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          ...
          <p className="text-[#ffff]">AndamanHub</p>
        </NavLink>
                  ...
                  return (
                    <React.Fragment>
                      ...
                      >
                        ...
                        >
                          <path
                            d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h-2V7zm1 8c.83 0 1.5.67 1.5 1.5S12.83 18 12 18s-1.5-.67-1.5-1.5S11.17 15 12 15z"
                            fill="white"
                          />
                        </svg>
                        Service
                  ...
                  return (
                    <React.Fragment>
                      ...
                      >
                        ...
                        >
                          <path d="M5 2v20l2-2 2 2 2-2 2 2 2-2 2 2V2z" />
              ...
              <li>
                ...
                >
                  <svg
                    ...
                    fill="currentColor"
                  >
                    <path d="M12 24c1.38 0 2.5-1.12 2.5-2.5h-5c0 1.38 1.12 2.5 2.5 2.5zm6.29-6c-1.01-1.01-1.29-2.67-1.29-4.5V9c0-3.53-2.61-6.43-6-6.92V2c0-.55-.45-1-1-1s-1 .45-1 1v.08C6.61 2.57 4 5.47 4 9v4.5c0 1.83-.28 3.49-1.29 4.5H3c-1.1 0-2 .9-2 2v1h20v-1c0-1.1-.9-2-2-2h-.71z" />
                  </svg>
                  Notification
                </NavLink>
              </li>
              ...
              <li>
                ...
                >
                  <svg
                    ...
                    fill="currentColor"
                  >
                    <path d="M21 19V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2ZM8.5 12.5 11 16l3-4 4 6H6l2.5-3.5ZM14 8a2 2 0 1 1 4 0 2 2 0 0 1-4 0Z" />
                  </svg>
                  Slider
                </NavLink>
              </li>
