...
import { useEditServiceCategoryMutation } from '../../../redux/api';
...
const EditCategory = () => {
  ...
  useEffect(() => {
    ...
    if (categoryData) {
      console.log('categoryData is categoryData', categoryData);

      setBgColor(categoryData?.bgColor);
      setName(categoryData?.name);
      setInputType(categoryData?.inputType);
      setcategoryId(categoryData?.id);
      if (categoryData?.inputType === 'numbering') {
        setNumberingKeys(categoryData?.numberings);
      }
    }
