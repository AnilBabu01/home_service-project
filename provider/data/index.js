...
export const faqs = [
  {
    ...
    answer:
      "To search for services, simply enter your location, select the type of service you need, and browse through the available options.",
    type: "General",
  },
  {
    question: "Can I view virtual tours of homes or spaces on this app?",
    answer:
      'Yes, you can view virtual tours of homes or spaces. Look for the "Virtual Tour" option on the listings to explore them virtually.',
    type: "General",
  },
  {
    question:
      "What should I do if I need to cancel or modify a service booking?",
    answer:
      'To cancel or modify a service booking, go to the "My Bookings" section, find your booking, and follow the provided options to make changes.',
    type: "Account",
  },
  {
    question: "How can I find services with specific features or requirements?",
    answer:
      "You can use the app’s search filters to find services with specific features or requirements. Filter results by amenities such as pet-friendly, cleaning frequency, or specific tasks.",
    type: "Booking",
  },
  {
    question:
      "Is there a way to make payments for service bookings within the app?",
    answer:
      "Yes, you can securely make payments for service bookings using various payment methods available in the app, including credit/debit cards and digital wallets.",
    type: "Payment",
  },
  {
  ...
  {
    question:
      "Can I request additional assistance with special requirements or preferences?",
    answer:
  ...
  },
  {
    ...
    answer:
      "After your service experience, you can provide feedback and rate your experience through the app’s rating and review system. Your feedback helps us improve our services for future users.",
    type: "General",
  },
  {
    question: "Is customer support available through this app?",
    answer:
      "While we provide booking services, our app is not for customer support. For assistance, please contact our support team through the designated channels provided in the app.",
    type: "General",
  },
];
...
export const notificationsIcons = [
  { type: "info", icon: icons.box },
  { type: "all", icon: icons.chat },
  { type: "user", icon: icons.chat },
  { type: "provider", icon: icons.chat },
  { type: "payment", icon: icons.discount },
  { type: "booking", icon: icons.bag },
  { type: "completeBooking", icon: icons.shieldOutline },
  { type: "cancelledBooking", icon: icons.cancelSquare },
];

export function getIconByType(type) {
  const item = notificationsIcons.find(
...
export const reviews = [
  {
    ...
    description:
      "Mariana did an amazing job! My house looks spotless and smells so fresh. Highly recommended! 😊👍",
    rating: 4.8,
    avgRating: 5,
    date: "2024-01-23T04:52:06.501Z",
  ...
  },
  {
    ...
    name: "James Johnson",
    description:
      "Mariana is the best cleaner I've ever hired! She's thorough, efficient, and friendly. Couldn't be happier!",
    rating: 4.7,
    avgRating: 5,
    date: "2024-01-23T04:52:06.501Z",
    numLikes: 120,
  },
  {
    ...
    name: "Emily Smith",
    description:
      "Mariana exceeded my expectations! She pays attention to every detail and leaves my home sparkling clean.",
    rating: 4.7,
    avgRating: 5,
  ...
  },
  {
    ...
    name: "David Brown",
    description:
      "Mariana did a great job cleaning my apartment. She's reliable and professional. Highly recommend!",
    rating: 4,
    avgRating: 4,
    date: "2024-01-29T04:52:06.501Z",
    numLikes: 384,
  },
  {
    ...
    description:
      "Mariana is fantastic! She's punctual, thorough, and friendly. My house has never looked better!",
    rating: 4.3,
    avgRating: 4,
    date: "2024-01-29T04:52:06.501Z",
    numLikes: 738,
  },
  {
    ...
    description:
      "Mariana is an excellent cleaner! She's reliable, efficient, and always does a fantastic job.",
    rating: 4.8,
    avgRating: 5,
    date: "2024-01-29T04:52:06.501Z",
    numLikes: 12,
  },
  {
    ...
    name: "Jessica Garcia",
    description:
      "Mariana is amazing! She goes above and beyond to ensure my home is clean and organized. Highly recommended!",
    rating: 4.9,
    avgRating: 5,
    date: "2024-01-29T04:52:06.501Z",
    numLikes: 450,
