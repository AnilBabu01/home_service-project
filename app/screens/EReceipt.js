...
import { getLastWord } from '../utils/functions'
...
const EReceipt = ({ navigation, route }) => {
    ...
    console.log(
        'isBooking  is isBooking',
        getLastWord(isBooking?.service?.address)
    )

    const renderContent = () => {
        const handleCopyToClipboard = async () => {
            await Clipboard.setStringAsync(isBooking.transactionId)
        ...
        return (
            <View style={{ marginVertical: 22 }}>
                <Barcode
                    format="EAN13"
                    value={isBooking?.transactionId}
                    text={isBooking?.transactionId}
                ...
                >
                    ...
                    <View style={styles.viewContainer}>
                        ...
                        >
                            {isBooking?.service?.category?.name}
                        </Text>
                    </View>
                    <View style={styles.viewContainer}>
                        ...
                        >
                            {isBooking?.service?.provider?.name}
                        </Text>
                    </View>
                    <View style={styles.viewContainer}>
                        ...
                        >
                            {formatDate(isBooking?.createdAt)}
                        </Text>
                    </View>
                </View>
                ...
                >
                    ...
                    <View style={styles.viewContainer}>
                        ...
                        >
                            {isBooking?.service?.provider?.mobile_no}
                        </Text>
                    </View>
                    <View style={styles.viewContainer}>
                        ...
                        >
                            {isBooking?.service?.provider?.email}
                        </Text>
                    </View>
                    <View style={styles.viewContainer}>
