    ...
    const handleShare = async () => {
        try {
            const result = await Share.share({
                message:
                    'Hey! Check out this awesome app: https://play.google.com/store/apps/details?id=com.andamanhub.user', 
            })
            ...
            showToast('Error', 'Unable to share at the moment.', 'error')
        }
    }
    ...
    const renderProfile = () => {
        ...
        const pickImage = async () => {
            try {
                ...
                // Declare formData before appending data
                const formData = new FormData()
                formData.append('profile', {
                    uri: tempUri, // Remove .uri because tempUri itself is a string
                    name: 'upload.jpg',
                    type: 'image/jpeg',
                })
